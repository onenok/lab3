...
document.addEventListener('DOMContentLoaded', () => {
    ...
    class Player {
        ...
        update(dt) {
            ...
            // 碰撞檢查
            if (this.checkOnGround() || this.checkCollisionEnities(dt)) {
                this.onGround = true;
            } else {
                this.onGround = false;
            }
            ...
            // Coyote Time 更新
            if (this.onGround) this.coyoteTime = CoyoteTOLERANCE;
    ...
    function gameLoop() {
        ...
        ctx.clearRect(0, 0, mapWidth, canvas.height);
        bar.draw();
